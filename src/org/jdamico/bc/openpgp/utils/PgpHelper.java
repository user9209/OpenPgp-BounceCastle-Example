...
public class PgpHelper {
    ...
    public byte[] createSignature(
        ...
        if (armor) {
            ByteArrayOutputStream byteArmored = new ByteArrayOutputStream();
            ArmoredOutputStream aOut = new ArmoredOutputStream(byteArmored);
            aOut.write(byteOut.toByteArray());
            aOut.flush();
            aOut.endClearText();
            aOut.close();

            out.write(byteArmored.toByteArray());
        } else {
